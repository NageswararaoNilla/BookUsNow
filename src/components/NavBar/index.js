  ...
  return (
    <>
      <div className="flex justify-between max-[480px]:justify-start">
        <div className="text-2xl font-bold text-red-600">BookUsNow</div>
        <div className="flex items-center gap-2">
          ...
          <div className="flex relative">
            <img
              src={search}
              alt="search-icon"
              className="w-4 h-4 absolute right-4 top-2 max-[480px]:relative max-[480px]:top-0  max-[480px]:left-20"
            />
            <input
              type="text"
              placeholder='"old phantom"'
              className="ps-4 w-96 border rounded-lg h-8 max-[480px]:hidden"
            />
          </div>
        </div>
        <div className="flex items-center gap-6 max-[480px]:gap-5 max-[480px]:ms-auto">
          <div className="flex items-center gap-2">
            ...
            <span className="max-[480px]:hidden">Favorites</span>
          </div>
          <div>
            <button className="border px-3 py-1 max-[480px]:hidden">
              Sign In
            </button>
            <img
              src={user}
              alt="profile-icon"
              className="w-4 h-4 min-[481px]:hidden"
            />
          </div>
        </div>
      </div>
